    ...
    <div className="infoContainer">
      <div className="infoContainerHeading">
        ...
        <div className="heading">
          <h2>
            Robust Infrastructure for <br className="notMobile" /> Seamless
            Operations
          </h2>
          <p>
            Our advanced setup empowers precision, speed, and scale:
            <br className="notMobile" /> backed by skilled hands and
            future-ready manufacturing tools.
          </p>
        </div>
      </div>
